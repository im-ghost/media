...
const Register2 = () => {
    ...
    return (<div className="flex flex-row text-center items-center justify-center w-screen h-screen min-h-screen  justify-center dark:text-amber-200 text-amber-800 bg-sky-300 dark:bg-slate-900 items-center p-0">
     ...
     {state.name && state.name.length < 2 && (<TextField id="name" label="Name" placeholder="Full name" InputProps={{
                value: state.name,
                onChange: (e) => {
                    setState({
                        type: "setName",
  ...
  {emailAuth &&
   ...
   {phoneAuth && (<Email value={state.email} onChange={setState}/>)}
