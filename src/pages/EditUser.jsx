...
const EditUser = () => {
    ...
    if (user) {
        if (user !== null) {
            ...
            return (<div className="text-center shadow rounded-lg">
     ...
     <TextField id="name" label="Name" placeholder="Full name" InputProps={{
                    value: state.name,
                    onChange: (e) => {
                        setState({
                            type: "setName",
     ...
     <TextField id="tel" label="Telephone" placeholder="Telephone" InputProps={{
                    type: "tel",
                    value: state.phone,
                    onChange: (e) => {
                        setState({
     ...
     <TextField id="email" label="Email Address" placeholder="medi@medi.com" InputProps={{
                    type: "email",
                    value: state.email,
                    onChange: (e) => {
                        setState({
     ...
     <TextField id="password" label="Password" placeholder="Your password" InputProps={{
                    type: "password",
     ...
     <TextField id="password" label="Password" placeholder="Comfirm Your password" InputProps={{
                    type: "password",
     ...
     <TextField id="bio" label="Bio" placeholder="Tell us something about yourself" InputProps={{
                    value: state.bio,
                    onChange: (e) => {
                        setState({
                            type: "setBio",
 ...
 {/*  <input
    ...
    return (<div className="p-2 rounded shadow" onClick={() => navigate("/login")}>
