  ...
  return (
    <Box className="text-center bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-40% to-emerald-500 to-100%  dark:from-blue-700 dark:from-20% dark:via-emarald-700 dark:via-30% dark:to-ryan-700 dark:to-100% dark:text-amber-500 text-amber-800 p-2">
      ...
      <div className="p-2 m-2">
        ...
        {phoneBtn && (
          <div
            className="text-center shadow-4xl rounded-[8px]  p-2 w-[50vw] h-[6vh] rounded-lg flex flex-col justify-evenly items-center border rounded-lg"
            onClick={() => {
              setPhone(true);
              setEmail(false);
              setOauth(false);
      ...
      <div className="p-2 m-2">
        {emailbtn && (
          <div
            className="text-center shadow-4xl rounded-[8px]  p-2 w-[50vw] h-[6vh] rounded-lg  flex flex-col justify-evenly border rounded-lg items-center"
            onClick={() => {
              setEmail(true);
              setPhone(false);
              setOauth(false);
