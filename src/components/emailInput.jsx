...
const EmailInput = () => {
    ...
    if (isDone) {
        return (<Box className="bg-gradient-to-r from-indigo-300 from-10% via-sky-300 via-40% to-emerald-300 to-100%  dark:from-blue-500 from-20% via-emarald-500 via-30% to-ryan-500 to-100% dark:text-amber-500 text-amber-800 rounded-lg">
     <Typography variant="h6"> A confirmation link has been sent to your email,click on the link to continue</Typography>
    </Box>);
    }
    return (<Box className="bg m-2">
    <TextField className="m-2 bg-gradient-to-r from-indigo-300 from-10% via-sky-300 via-40% to-emerald-300 to-100%  dark:from-blue-500 from-20% via-emarald-500 via-30% to-ryan-500 to-100% dark:text-amber-900 text-amber-700 rounded-lg" label="Email Address" placeholder="culestfrosh@gmail.com" InputProps={{
            value: email,
