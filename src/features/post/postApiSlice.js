...
export const { useLikePostMutation, useRetweetPostMutation, useCommentOnPostMutation, useCreatePostMutation, useDeletePostMutation, useUpdatePostMutation, useGetPostByIdQuery, useAllPostsQuery, } = postApiSlice;
